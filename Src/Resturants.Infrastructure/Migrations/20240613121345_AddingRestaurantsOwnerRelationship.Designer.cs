...
namespace Resturants.Infrastructure.Migrations
{
    ...
    [Migration("20240613121345_AddingRestaurantsOwnerRelationship")]
    partial class AddingRestaurantsOwnerRelationship
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("Resturants.Domain.Entities.ApplicationUser", b =>
                {
                    b.Property<string>("Id")
                        .HasColumnType("nvarchar(450)");
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<string>", b =>
                {
                    b.HasOne("Resturants.Domain.Entities.ApplicationUser", null)
                        .WithMany()
            ...
            modelBuilder.Entity("Resturants.Domain.Entities.Restaurant", b =>
                {
                    b.HasOne("Resturants.Domain.Entities.ApplicationUser", "Owner")
